...
router.put(
  ...
  [
    ...
    body('dueDate').optional().isString().withMessage('Due date should be a string'),
    body('totalPoints').optional().isNumeric().withMessage('Total points should be a number'),
    body('responseInstructions')
      .optional()
      .isString()
      .withMessage('Response instructions should be a string'),
    body('assignmentType').optional().isString().withMessage('Assignment type should be a string'),
  ],
